...
<li><a href="#">Daily sell entry</a> </li><br>
...
<article>
<h1 style="color:rgb(160, 127, 140)">Daily Sell Entry</h1>
<?php
    $conn=new  mysqli("localhost","root","","pharmacy");

    
    if(isset($_REQUEST['submit'])){
        if(($_REQUEST['name']=="")||($_REQUEST['group']=="")||($_REQUEST['company']=="")||($_REQUEST['quantity']=="")||($_REQUEST['price']=="")){
            echo "fill the form";
        }
        else{
            $name=$_REQUEST['name'];
        ...
        $sql="INSERT INTO daily_sell (name,mGroup,company,quantity,price,total) VALUE ('$name','$group','$company','$quantity','$price','$total')";
